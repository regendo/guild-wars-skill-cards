...
pub struct Skill {
	...
	pub cost_energy: Option<u8>,
	pub cost_adrenaline: Option<u8>,
	pub cost_overcast: Option<u8>,
	pub cost_upkeep: Option<i8>,
	pub cost_sacrifice: Option<u8>,
	pub cast_time: Option<f32>,
	pub recharge_time: Option<u8>,
